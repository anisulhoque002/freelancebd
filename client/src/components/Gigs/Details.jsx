        ...
        <div className="col-span-2 flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-2 items-center">
              ...
              <Link href={`/userprofile/${gigData.createdBy.id}`}>
                <h6 className="text-[#74767e] hover:text-[#1DBF73] transition-colors">@{gigData.createdBy.username}</h6>
              </Link>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex gap-2 items-center">
                  ...
                  <Link href={`/userprofile/${gigData.createdBy.id}`}>
                    <span className="text-[#74767e] hover:text-[#1DBF73] transition-colors">
