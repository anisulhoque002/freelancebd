        ...
        <div className="flex min-h-[80vh] my-10 mt-0 px-32 gap-5">
          ...
          <div>
            <div className="grid grid-cols-3 gap-10 w-full">
              ...
              >
                <h2 className="text-xl">{t("seller.dashboard.totalGigs")}</h2>
              ...
              >
                <h2 className="text-xl">{t("seller.dashboard.totalOrders")}</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
              ...
              >
                <h2 className="text-xl">{t("seller.dashboard.unreadMessages")}</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
              ...
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className="text-xl">{t("seller.dashboard.earningsToday")}</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
                  ৳{dashboardData?.dailyRevenue}
                </h3>
              </div>
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className="text-xl">{t("seller.dashboard.earningsMonthly")}</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
                  ৳{dashboardData?.monthlyRevenue}
                </h3>
              </div>
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className="text-xl">{t("seller.dashboard.earningsYearly")}</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
